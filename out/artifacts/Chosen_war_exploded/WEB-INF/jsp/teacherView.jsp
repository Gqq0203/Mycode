...
<%--                所有与该教师相关的学生志愿都在registerList集合中--%>
                    <c:forEach var="register" items="${registerList}" varStatus="loop">
                        <tr>
                            ...
                            <td><fmt:formatDate type="date" value="${register.time}" pattern="yyyy-MM-dd HH:mm"/></td>
                            <c:if test="${register.state==0}">
                                <td>
                                    <a href="${pageContext.request.contextPath}/teacher/addTeacherRegister/<%=teacher.getTno()%>/${register.sno}/${register.rid}/${register.able}/${register.time}">选择</a>
                                    <a href="${pageContext.request.contextPath}/teacher/refuseStudent/${register.rid}/${register.able}/${register.sno}">拒绝</a>
                                </td>
                            </c:if>
